...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--results', type=str, default="outputs", help='save test results to this path.')
        ...
        parser.add_argument('--no_aus_noise', action='store_true', help='if not specified, add noise to target AUs.')
        ...
        parser.add_argument('--ngf', type=int, default=64, help='ngf')  # Original default was 64, changed to 32 for local model
    ...
    def parse(self):
        ...
        if opt.mode == "test":
            ...
            opt.results = os.path.join(opt.results, "%s_%s" % (opt.name, opt.load_epoch))
